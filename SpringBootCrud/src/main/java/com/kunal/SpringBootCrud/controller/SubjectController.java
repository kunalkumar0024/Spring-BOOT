...
//	@GetMapping("/get-all-subjects-client")
//	public Subject getAllSubject1() {
//		String url="http://localhost:8083/get-all-subjects";
//		RestTemplate restTemplate=new RestTemplate();
//		Subject result=restTemplate.getForObject(url, Subject.class);
//		return result;
//	}
}
